...
BASE_URL = 'http://maxgo.com'
CATALOG_URL = 'http://catalog.lv3.maxgo.com'

# Main Menu
NAV_URL = CATALOG_URL + '/apps/mediacatalog/rest/navigationBarService/MAX/navigationBar/NO_PC'
# Main category page called from main menu to load landing bar on page
LANDING_URL = CATALOG_URL + '/apps/mediacatalog/rest/landingService/MAX/landing/%s'
# Category pages to filter category page (A-Z, Genre)
QUICKLINKS_URL = CATALOG_URL + '/apps/mediacatalog/rest/quicklinkService/MAX/quicklink/%s'
# MAX uses a couple different XML layouts for pages (ex: Bundle = TV Seasons)
BUNDLE_URL = 'http://catalog.lv3.maxgo.com/apps/mediacatalog/rest/productBrowseService/MAX/bundle/%s'
CATEGORY_URL = 'http://catalog.lv3.maxgo.com/apps/mediacatalog/rest/productBrowseService/MAX/category/%s'

NAMESPACE = {'xsi': 'http://www.w3.org/2001/XMLSchema-instance'}

# Page used to pull up video
STREAM_URL = 'http://www.maxgo.com/#series/video&assetID=%s?videoMode=embeddedVideo?showSpecialFeatures=false&provider=%s'
...
####################################################################################################
# Loads MaxGO menu from home page.
@handler('/video/cinemax', NAME, art = ART, thumb = ICON)
def MainMenu():
...
@route('/video/cinemax/{landingTypeCode}')
...
@route('/video/cinemax/{landingTypeCode}/filter/{parent}')
...
@route('/video/cinemax/{landingTypeCode}/browse')
def BrowseMenu(title, landingTypeCode, url):
    ...
    if type == 'productBrowseResponse':
        ...
        # TV Show (Copy and Paste from SeasonsMenu for now)
...
@route('/video/cinemax/{landingTypeCode}/landing')
...
@route('/video/cinemax/{landingTypeCode}/{title}/seasons')
...
@route('/video/cinemax/{landingTypeCode}/{title}/{seasonNum}/episodes')
